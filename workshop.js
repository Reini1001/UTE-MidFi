...
function game_load() {
	...
	if (game) {
		document.getElementById("game").innerHTML = "" +
			"<img onclick='url_game()' alt='' width='16' src='icons/x.svg' height='16'>" +
			"<h2>" + game + "</h2>";
	}
	else {
		document.getElementById("game").innerHTML = "" +
			"<h2>Kein Spiel ausgewählt</h2>" +
			"<div class=\"last-played\" onclick='set_game(\"Spiel 3\")'>Spiel 3</div>" +
			"<div class=\"last-played\" onclick='set_game(\"Spiel 2\")'>Spiel 2</div>" +
			"<div class=\"last-played\" onclick='set_game(\"Spiel 1\")'>Spiel 1</div>";
	}
